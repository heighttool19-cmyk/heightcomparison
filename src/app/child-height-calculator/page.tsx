...
export default function HeightCalculatorPage() {
    return (
        <div className="flex flex-col min-h-screen bg-bg font-sans text-foreground selection:bg-accent/20 transition-colors duration-500 overflow-x-clip">
            <ThemeInitializer />
            ...
            <footer className="bg-surface border-t border-border mt-auto font-medium">
                <div className="max-w-4xl mx-auto px-6 py-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-muted">
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <span className="text-border hidden sm:inline">|</span>
                        <Link href="#child-height-calculator-faq" className="hover:text-foreground">FAQ</Link>
                        <span className="text-border hidden sm:inline">|</span>
