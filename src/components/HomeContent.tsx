                    ...
                    <div className="flex flex-col gap-12 w-full min-w-0 max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6 text-center sm:text-left mt-4">
                            ...
                            <div className="bg-surface border-l-4 border-[#22c55e] rounded-r-2xl p-5 my-6 shadow-sm">
                                <p className="mb-3 text-[14px] text-muted leading-[1.7]">
                                    A height comparison tool converts any two or more heights into a proportional side-by-side visual — each bar scaled to the exact mathematical ratio between the entered measurements. A 15 cm gap between 170 cm and 185 cm renders as a 1.09× bar ratio on screen.
                                </p>
                                <p className="m-0 text-[14px] text-muted leading-[1.7]">
                                    The same proportional scale applies whether you are comparing two people, a person against a celebrity, fictional characters from the same series, or a human height against a real-world object like K2 at 8,611 m. Every subject type — people, celebrities, fictional characters, entities, and uploaded photos — shares one accurate visual scale. Results update in real time with no account or setup required.
                                </p>
                            </div>
                        ...
                        <section id="how-does-a-height-comparison-chart-work" className="space-y-4 scroll-mt-24">
                            ...
                            <p className="text-[15px] leading-[1.7] text-muted">
                                A height comparison chart converts raw height measurements into proportional bars — each bar represents the exact ratio between any two entered heights, rendered visually at true scale.
                            </p>
                            <p className="text-[15px] leading-[1.7] text-muted">
                                ...
                                <div className="flex flex-col sm:flex-row border-b border-border">
                                    ...
                                    <div className="flex-1 p-5 md:p-8">
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-5">
                                            <span className="inline-flex items-center gap-2 text-[12px] font-bold px-4 py-1.5 rounded-full border border-border bg-bg text-muted"><span className="w-2 h-2 rounded-full bg-[#22c55e]"></span>People</span>
                                            <span className="inline-flex items-center gap-2 text-[12px] font-bold px-4 py-1.5 rounded-full border border-border bg-bg text-muted"><span className="w-2 h-2 rounded-full bg-[#EF9F27]"></span>Celebrities</span>
                                            <span className="inline-flex items-center gap-2 text-[12px] font-bold px-4 py-1.5 rounded-full border border-border bg-bg text-muted"><span className="w-2 h-2 rounded-full bg-[#9F77DD]"></span>Fictional characters</span>
                                            <span className="inline-flex items-center gap-2 text-[12px] font-bold px-4 py-1.5 rounded-full border border-border bg-bg text-muted"><span className="w-2 h-2 rounded-full bg-[#378ADD]"></span>Objects and entities</span>
                                            <span className="inline-flex items-center gap-2 text-[12px] font-bold px-4 py-1.5 rounded-full border border-border bg-bg text-muted"><span className="w-2 h-2 rounded-full bg-[#1D9E75]"></span>Your own photo</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row border-b border-border">
                                    ...
                                    <div className="flex-1 p-5 md:p-8">
                                        ...
                                        <div className="space-y-3 mb-5">
                                            <p className="text-[14px] text-muted leading-[1.7]"><strong className="text-foreground">Add Person</strong> — Enter a name (optional), select Male or Female, type a height in cm or ft/in, and pick a color. Hit Add Person and your bar appears instantly.</p>
                                            <p className="text-[14px] text-muted leading-[1.7]"><strong className="text-foreground">Celebrities</strong> — Search any name across Athletes, Bollywood, British, Asian Celebs, and more. Every result shows height in both cm and ft/in. Hit + and they are on your chart.</p>
                                            <p className="text-[14px] text-muted leading-[1.7]"><strong className="text-foreground">Fictional</strong> — Browse Anime, Cartoons, DC Comics, and Fantasy. Search by character name or series. All heights come from official source material.</p>
                                            <p className="text-[14px] text-muted leading-[1.7]"><strong className="text-foreground">Entities</strong> — Search any animal, landmark, or object. A Patagonian Cypress tree, a double-decker bus, Angel Falls, K2 — if it has a real height, it is probably in there. Everything renders at verified real-world scale.</p>
                                            <p className="text-[14px] text-muted leading-[1.7]"><strong className="text-foreground">Add Image</strong> — Upload a photo, enter the real height, and it slots into the chart scaled accurately against everything else. The most personal way to use the tool.</p>
                                        </div>

                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                            <div className="bg-bg border border-border rounded-xl p-4">
                                                <div className="text-[12px] font-bold text-muted mb-2">Celebrity ideas</div>
                                                <div className="text-[12px] text-[#22c55e] leading-[1.6] font-medium">Jackie Chan 174 cm · Wembanyama 224 cm · Taylor Swift 178 cm</div>
                                            </div>
                                            <div className="bg-bg border border-border rounded-xl p-4">
                                                <div className="text-[12px] font-bold text-muted mb-2">Character ideas</div>
                                                <div className="text-[12px] text-[#22c55e] leading-[1.6] font-medium">Goku 175 cm · Piccolo 226 cm · Levi 160 cm</div>
                                            </div>
                                            <div className="bg-bg border border-border rounded-xl p-4">
                                                <div className="text-[12px] font-bold text-muted mb-2">Entity ideas</div>
                                                <div className="text-[12px] text-[#22c55e] leading-[1.6] font-medium">K2 8,611 m · CN Tower 553 m · Saltasaurus 6 m</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-bg border border-border rounded-xl p-4 mt-4 flex gap-3 items-start text-[13px] text-muted">
                                            ...
                                            <span>The chart scales up to 10,000 meters — 32,808 feet. K2 at 8,611 m and Kilimanjaro at 5,895 m both fit on the same chart as a person at 175 cm. The proportional difference is what makes it genuinely striking.</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section id="why-a-visual-height-comparison-shows-more-than-numbers" className="space-y-4 scroll-mt-24">
                            ...
                            <h2 className="text-2xl md:text-3xl font-black tracking-tight text-foreground">Why a Visual Height Comparison Shows More Than Numbers</h2>

                            <p className="text-[15px] leading-[1.7] text-muted mb-8">
                                A proportional height comparison renders the mathematical relationship between two or more heights as a scaled visual — making the size difference between subjects immediately readable without calculation.
                            </p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm">
                                    ...
                                    <div className="text-[14px] text-muted leading-[1.6]">A 175 cm person placed next to K2 at 8,611 m on the same proportional chart shows the true scale relationship between human height and natural landmarks in a way statistics alone cannot.</div>
                                </div>
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm">
                        ...
                        <section id="comparing-heights-examples-and-use-cases" className="space-y-4 scroll-mt-24">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <span className="inline-block self-start text-[11px] font-bold px-2.5 py-[3px] rounded-md bg-[#E1F5EE] dark:bg-emerald-900/30 text-[#085041] dark:text-emerald-400 border border-[#9FE1CB] dark:border-emerald-500/30 mb-3 uppercase tracking-wide">Couples and friends</span>
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <span className="inline-block self-start text-[11px] font-bold px-2.5 py-[3px] rounded-md bg-[#E1F5EE] dark:bg-emerald-900/30 text-[#085041] dark:text-emerald-400 border border-[#9FE1CB] dark:border-emerald-500/30 mb-3 uppercase tracking-wide">Sports and athletes</span>
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <span className="inline-block self-start text-[11px] font-bold px-2.5 py-[3px] rounded-md bg-[#E1F5EE] dark:bg-emerald-900/30 text-[#085041] dark:text-emerald-400 border border-[#9FE1CB] dark:border-emerald-500/30 mb-3 uppercase tracking-wide">Anime and fandom</span>
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <span className="inline-block self-start text-[11px] font-bold px-2.5 py-[3px] rounded-md bg-[#E1F5EE] dark:bg-emerald-900/30 text-[#085041] dark:text-emerald-400 border border-[#9FE1CB] dark:border-emerald-500/30 mb-3 uppercase tracking-wide">Objects and real-world scale</span>
                                    <div className="text-[14px] font-medium italic text-foreground mb-3 leading-[1.5]">"I had no idea it was actually that big."</div>
                                    <div className="text-[14px] text-muted leading-[1.6] mb-4 flex-1">Place a person next to a Patagonian Cypress (60 m), Angel Falls (979 m), or K2 (8,611 m) and the proportional chart makes the scale immediately real.</div>
                                    <div className="text-[12px] font-medium text-muted/70 pt-3 border-t border-border leading-[1.5]">Try: person 175 cm → Chrysler Building 319 m → Angel Falls 979 m → K2 8,611 m</div>
                                </div>
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <span className="inline-block self-start text-[11px] font-bold px-2.5 py-[3px] rounded-md bg-[#E1F5EE] dark:bg-emerald-900/30 text-[#085041] dark:text-emerald-400 border border-[#9FE1CB] dark:border-emerald-500/30 mb-3 uppercase tracking-wide">Me vs celebrity</span>
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <span className="inline-block self-start text-[11px] font-bold px-2.5 py-[3px] rounded-md bg-[#E1F5EE] dark:bg-emerald-900/30 text-[#085041] dark:text-emerald-400 border border-[#9FE1CB] dark:border-emerald-500/30 mb-3 uppercase tracking-wide">Planning and design</span>
                        ...
                        <section id="height-generator-comparison-all-features-all-free" className="space-y-4 scroll-mt-24">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    ...
                                    <div className="text-[14px] text-muted leading-[1.6] mb-4 flex-1">Type any height and your proportional bar appears straight away. The chart updates live as you type — no submit button, no reload. Switch between cm and ft/in any time with one tap.</div>
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    ...
                                    <div className="text-[12px] font-medium text-muted/70 pt-3 border-t border-border leading-[1.5]">6 colors · Male and female styles · No entry limit</div>
                                </div>
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    <div className="text-[15px] font-bold mb-3 flex items-center gap-2.5 text-foreground">
                                ...
                                <div className="bg-surface rounded-2xl p-6 border border-border shadow-sm flex flex-col">
                                    ...
                                    <div className="text-[14px] text-muted leading-[1.6] mb-4 flex-1">Add animals, landmarks, buildings, and objects at verified real-world dimensions. A Saltasaurus at 6 m, the CN Tower at 553 m, or K2 at 8,611 m — all on the same chart as a person.</div>
                        ...
                        <div className="bg-surface rounded-3xl p-8 text-center border border-border my-4 shadow-xl">
                            ...
                            <div className="flex flex-wrap justify-center gap-4">
                                <button onClick={scrollToTop} className="inline-flex items-center gap-2 h-12 px-6 bg-[#22c55e] border-none rounded-full text-white text-[14px] font-bold cursor-pointer hover:bg-green-600 transition-all shadow-md hover:-translate-y-0.5">
                                    ↑ Start Comparing Heights
                                </button>
                                <button onClick={scrollToTop} className="inline-flex items-center gap-2 h-12 px-6 bg-bg border border-border rounded-full text-foreground text-[14px] font-bold cursor-pointer hover:bg-surface transition-all shadow-sm hover:-translate-y-0.5">
