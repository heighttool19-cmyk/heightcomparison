    ...
    return (
        <div className="bg-surface rounded-3xl p-8 text-center border border-border my-4 shadow-xl">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                <button onClick={() => openDashboardPanel('ADD_PERSON')} className="inline-flex items-center gap-2 h-12 px-6 bg-accent border-none rounded-full text-zinc-950 text-[14px] font-bold cursor-pointer hover:brightness-110 transition-all shadow-md hover:-translate-y-0.5 btn-glow">
                    ↑ Start Comparing
                </button>
