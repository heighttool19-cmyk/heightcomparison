...
const HeightDashboard: React.FC<HeightDashboardProps> = ({
    ...
    }, [persons, vpHeight, vpWidth, baseScale, isMobile]);
            ...
            <div className="flex flex-1 overflow-hidden relative flex-col md:flex-row bg-bg transition-colors duration-500">
                ...
                {!readOnly && (
                    <motion.aside
                        ...
                        className="shrink-0 w-full h-[80px] bg-bg border-b border-border/50 z-40 flex overflow-x-auto overflow-y-hidden custom-scrollbar sm:static sm:w-[85px] sm:overflow-y-auto sm:overflow-x-hidden sm:h-full sm:border-b-0 sm:border-r sm:flex-col"
                    >
                ...
                >
                    {/* Toolbar */}
                    <div className="order-2 sm:order-first px-2 lg:px-4 pt-4 z-30 w-full mb-4 shrink-0">
