    ...
    return (
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
            <button
                onClick={recalibrate}
                className={cn(
                    "px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl font-black uppercase tracking-widest text-[10px] sm:text-xs flex items-center justify-center gap-1.5 sm:gap-2 border transition-all whitespace-nowrap",
            ...
            <button
                ...
                className="col-span-2 sm:col-span-1 px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl font-black uppercase tracking-widest text-[10px] sm:text-xs flex items-center justify-center gap-1.5 sm:gap-2 bg-surface border-border text-muted hover:text-foreground hover:border-accent/30 transition-all border"
                title="Upload Another Image"
            >
                <RefreshCcw className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0" />
                <span className="whitespace-nowrap">New Image</span>
            </button>
        </div>
    );
};