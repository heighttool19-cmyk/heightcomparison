                    ...
                    >
                        ...
                        <span className="font-black  uppercase  leading-none whitespace-nowrap drop-shadow-md  text-center w-full"
                            style={{
                                ...
                                fontSize: `${Math.max(10, Math.min(20, 8 * Math.pow(person.heightCm / 170, 0.35))) * Math.max(0.25, nameScale * 0.48 * Math.min(1, (effectiveWidth * 0.9) / (person.name.length * 8)))
                                    }px`,
                        ...
                        <span className="  font-black text-accent tracking-tighter whitespace-nowrap leading-none mt-1.5  text-center rounded  py-0.5   w-full"
                            style={{
